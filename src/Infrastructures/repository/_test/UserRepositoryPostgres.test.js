...
describe("UserRepositoryPostgres", () => {
  ...
  describe("getUser function", () => {
    it("should throw InvariantError when user not found", async () => {
      ...
      // Action & Assert
      await expect(
        userRepositoryPostgres.getUser("user-123")
      ).rejects.toThrowError(InvariantError);
    });

    it("should return user data correctly when user is found", async () => {
      // Arrange
      const userData = {
        id: "user-456",
        username: "dicoding",
      ...
      // Action
      const user = await userRepositoryPostgres.getUser("user-456");
